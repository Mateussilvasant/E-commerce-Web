		...
		<div class="container-fluid">
			...
			<div class="pb-4">
				...
				<div class="form-group">
					...
					<label class="py-2" for="idPreco">Preço: </label>

					<div class="input-group mb-3">

						<div class="input-group-prepend">
							<span id="priceSymbol" class="input-group-text">R$</span>
						</div>
						<input aria-describedby="priceSymbol" form="formCadastrarProduto"
							step="0.01" placeholder="0.00" type="number" class="form-control"
					...
					<div class="form-group py-4">
						<form:radiobutton form="formCadastrarProduto"
							path="produto.status" checked="checked" value="Disponível" />
						Disponível
						<form:radiobutton form="formCadastrarProduto"
							path="produto.status" value="Indisponível" />
						Indisponível
					</div>
				</div>
						...
						<div class="row">
							...
							<div class="col-lg-6 col-sm-3 pt-2">
								...
								<div class="input-group mb-3">
									...
									<input class="form-control" type="text" id="categoriaBuscadaID" />
								</div>
							</div>
				...
				<div class="d-flex justify-content-end form-group p-4">
					<input id="cadastrarProdutoID" class="btn btn-primary"
